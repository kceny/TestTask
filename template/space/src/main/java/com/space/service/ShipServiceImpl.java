...
public class ShipServiceImpl implements ShipService {
    ...
    //получать отфильтрованный список кораблей в соответствии с переданными фильтрами getFilteredShipsList()
    @Override
    ...
    /*createShip(String name, String planet, ShipType shipType, long prodDate, double speed, int crewSize) */
    @Override
    ...
    //name.length() > 50 && planet.length() > 50 && name.isEmpty() && planet.isEmpty()
    private boolean isStringValid(String value) {
        final int maxStringLength = 50;
        return value != null && !value.isEmpty() && value.length() <= maxStringLength;
    }

    //prodDate<0 && prodDate<2800 && prodDate>3019
